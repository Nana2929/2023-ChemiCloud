...
from preprocess_utils.clean_en_dictionaries import clean_en_dictionaries
import logging
...
def main():
    ...
    if not (dictionaries_dir / "chemical_list_en-cleaned.txt").exists():
        clean_en_dictionaries(dictionaries_dir)
    ...
    for article in articles:
        print(article)
        pprint(determiner.extract_chemical(article))
        print()
